-- Run this SQL script directly in your PostgreSQL database to create the ai_attitude_responses table
-- You can run it using psql or any PostgreSQL client:
-- psql -U sim_user -d simulation_db -f backend/src/database/migrations/add_ai_attitude_table.sql
